...
public class RoleImpl extends MinimalEObjectImpl.Container implements Role {
	...
	protected EClass eStaticClass() {
		return ProgrammaticACPackage.Literals.ROLE;
	}
	...
	public EList<Permission> getPermissions() {
		if (permissions == null) {
			permissions = new EObjectContainmentEList<Permission>(Permission.class, this, ProgrammaticACPackage.ROLE__PERMISSIONS);
		}
		return permissions;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProgrammaticACPackage.ROLE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProgrammaticACPackage.ROLE__PERMISSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ProgrammaticACPackage.ROLE__NAME:
				return getName();
		}
