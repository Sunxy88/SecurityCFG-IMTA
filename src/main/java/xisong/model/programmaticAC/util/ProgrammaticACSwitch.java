...
public class ProgrammaticACSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProgrammaticACPackage.AC_POLICY: {
				ACPolicy acPolicy = (ACPolicy)theEObject;
				T result = caseACPolicy(acPolicy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.ROLE: {
				Role role = (Role)theEObject;
				T result = caseRole(role);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.OBJECT: {
				xisong.model.programmaticAC.Object object = (xisong.model.programmaticAC.Object)theEObject;
				T result = caseObject(object);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.PERMISSION: {
				Permission permission = (Permission)theEObject;
				T result = casePermission(permission);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = caseObject(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgrammaticACPackage.EXECUTE: {
				Execute execute = (Execute)theEObject;
				T result = caseExecute(execute);
				if (result == null) result = caseAction(execute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AC Policy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>AC Policy</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseACPolicy(ACPolicy object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseObject(xisong.model.programmaticAC.Object object) {
		return null;
	}
